...
import com.sophs.cursomc.repositories.ItemPedidoRepository;
import com.sophs.cursomc.repositories.PagamentoRepository;
import com.sophs.cursomc.repositories.PedidoRepository;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat4 = new Categoria(null, "Eletrônocos");
		...
		Produto p8 = new Produto(null, "Roçaderira", 800.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "sophiabrenda10@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "cc19829@g.unicamp.br", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
